...
#ifndef RIPPLE_TEST_JTX_ZK_H_INCLUDED
#define RIPPLE_TEST_JTX_ZK_H_INCLUDED
...
/** Sets the optional ZKDocument on a ZkVerify. */
class document
{
private:
...
public:
    ...
    {
        jtx.jv[sfZKDocument.jsonName] = document_;
    }
};

/** Sets the optional URI on a ZkVerify. */
class uri
{
private:
    std::string uri_;
...
/** Sets the optional Attestation on a ZkVerify. */
class data
{
private:
    std::string data_;
